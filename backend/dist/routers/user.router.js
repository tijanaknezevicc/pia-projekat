...
userRouter.route('/update-user').post(upload.single('pfp'), (req, res) => new user_controller_1.UserController().updateUser(req, res));
userRouter.route('/change-password').post((req, res) => new user_controller_1.UserController().changePassword(req, res));
userRouter.route('/get-users').get((req, res) => new user_controller_1.UserController().getAllUsers(req, res));
userRouter.route('/change-active-status').post((req, res) => new user_controller_1.UserController().changeActiveStatus(req, res));
userRouter.route('/approve-user').post((req, res) => new user_controller_1.UserController().approveUser(req, res));
userRouter.route('/reject-user').post((req, res) => new user_controller_1.UserController().rejectUser(req, res));
